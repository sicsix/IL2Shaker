### NOTE
IL2Shaker v1 is no longer being developed.

IL2Shaker v2 is a major overhaul that can be downloaded at [https://sicsix.itch.io/il2shaker](https://sicsix.itch.io/il2shaker).

...
public record EngineDataEvent : Event
{
    public readonly int     Index;
    public readonly Vector3 Offset;
    public readonly float   MaxRPM;

    public EngineDataEvent(uint tick, byte[] packet, int offset) : base(tick, packet, offset)
    {
        ...
        MaxRPM = BitConverter.ToSingle(packet, offset + 16);
    }
}
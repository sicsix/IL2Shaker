...
public record BombReleaseEvent : Event
{
    public readonly Vector3 Offset;
    public readonly float   Mass;
    public readonly ushort  Type; // Appears to always be 0 to indicate bomb

    public BombReleaseEvent(uint tick, byte[] packet, int offset) : base(tick, packet, offset)
    {
        Offset = new Vector3
        {
